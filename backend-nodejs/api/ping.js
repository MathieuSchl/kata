...
async function startApi(app) {
  app.get("/api/v1/ping/", async function (req, res) {
  ...
  app.post("/api/v1/ping/", async function (req, res) {
    const data = await require("../functions/apiActions").prepareData(app, req, res);
    try {
  ...
  app.put("/api/v1/ping/", async function (req, res) {
    const data = await require("../functions/apiActions").prepareData(app, req, res);
    try {
  ...
  app.delete("/api/v1/ping/", async function (req, res) {
    const data = await require("../functions/apiActions").prepareData(app, req, res);
    try {
      const result = await pingDelete(data);
      await require("../functions/apiActions").sendResponse(req, res, result);
